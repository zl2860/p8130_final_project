...
|             | Publication | Experience |  log\_sal94 |  log\_sal95 |
| ----------- | ----------: | ---------: | ----------: | ----------: |
| Publication |   1.0000000 |  0.1119603 | \-0.7667516 | \-0.7696988 |
| Experience  |   0.1119603 |  1.0000000 |   0.3152043 |   0.3141280 |
...
```
    ...
    ## 
    ## Call:
    ## lm(formula = log_sal94 ~ gender * Title, data = lawsuit_df)
    ## 
    ## Residuals:
    ...
    ## TitleAssociate Professor              -0.14468    0.10045  -1.440   0.1510
    ## TitleFull Professor                   -0.02620    0.09049  -0.290   0.7724
    ## genderFemale:TitleAssociate Professor  0.27194    0.15350   1.772   0.0777
    ## genderFemale:TitleFull Professor       0.40560    0.15777   2.571   0.0107
    ##                                          
    ## (Intercept)                           ***
    ## genderFemale                          ***
    ## TitleAssociate Professor                 
    ## TitleFull Professor                      
    ## genderFemale:TitleAssociate Professor .  
    ## genderFemale:TitleFull Professor      *  
    ## ---
